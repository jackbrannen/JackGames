                      ...
                      <div key={p.id} style={{ display: "flex", alignItems: "center", gap: 6, padding: "6px 2px" }}>
                        ...
                        {onRemovePlayer && p.id !== myPlayerId && (
                          <button
                            ...
                            aria-label={`Remove ${p.name}`}
                            style={{ background: "transparent", border: "none", color: "rgba(255,255,255,0.5)", fontSize: 15, fontWeight: 800, cursor: "pointer", padding: "2px 4px", lineHeight: 1, flexShrink: 0 }}
                          >
                            ✕
                          </button>
                        )}
