...
// when the same browser has multiple tabs of the game open, silently breaking
// that tab's Supabase calls. Disabling the unused auth lifecycle removes the
// lock entirely (same fix applied to ExquisiteCorpse).
