...
export default function EndGame({
  ...
  bottomPad = "40px",
  colors = {},
  scoreTextColor = "white",  // non-winner score badge number — override when wl isn't dark enough for white
  linkBg = "rgba(255,255,255,0.15)",   // "Play Another Game" link background
  linkTextColor = "white",             // "Play Another Game" link text — override alongside linkBg
}) {
    ...
    <div style={{ flex: 1, minHeight: 0, overflowY: "auto", padding: "40px 24px", paddingBottom: bottomPad, animation: "endGameIn 300ms ease-out both" }}>
          ...
          return (
            <div key={p.id} style={{ display: "flex" }}>
              <div style={{
                ...
                fontSize: 18, fontWeight: 900, color: isWinner ? "#000" : scoreTextColor,
      ...
      <div style={{ marginTop: 40, display: "flex", flexDirection: "column", gap: 10 }}>
        ...
        <a
          ...
          style={{ background: linkBg, color: linkTextColor, fontSize: 16, fontWeight: 700, padding: "14px 24px", width: "100%", display: "block", textAlign: "center", textDecoration: "none" }}
        >
          Play Another Game
        </a>
      </div>
