...
export default function WaitingList({
  ...
  pokeJustSent = null,
  showCount = true,
  doneColor = "#22C55E", // override when the default green doesn't have enough contrast on a light/green surface
}) {
          ...
          return (
            <div key={p.name} style={{ display: "flex", alignItems: "center", background: mid, padding: "13px 16px", gap: 10 }}>
              <div style={{
                ...
                background: p.done ? doneColor : "rgba(255,255,255,0.25)",
              }} />
              <div style={{ flex: 1 }}>
