...
export default function HomeScreen({
  ...
  const { bg = "#111", wl = "#333", yellow = "#FBDF54", text = "white", createText = "#000", muted } = colors
  const mutedText = muted ?? (text === "white" ? "rgba(255,255,255,0.65)" : "rgba(60,48,34,0.6)")
