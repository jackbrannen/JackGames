...
const BG = "#E8553A"
const INK = "#2A2D34"
const WARM = "#FBD7CC"       // light coral tint — join field / dummy button
...
export default function Home() {
  ...
  return (
    <HomeScreen
      title="Typecast"
      subtitle="Assign a word for each player, then guess how everyone else did"
      ...
      isDummy={isCreating}
      colors={{ bg: BG, wl: WARM, yellow: INK, text: INK, createText: "#FFF1EA" }}
    />
  )
}
